...
<div class="tailwind">
    <a href="{{ $post['sectionPageAncestor']['href'] }}" class="inline-flex items-center border border-primary hover:border-black text-link hover:text-black p-3 hover:bg-[#0001] transition-colors">
